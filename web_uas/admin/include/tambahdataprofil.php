        ...
        <div class="col-sm-12 mb-4 mx-auto">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary far fa-list-alt"> Form Tambah Data Profil</h6>
                    <a href="index.php?include=data-profil" class="btn btn-sm btn-warning float-right"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
                </div>
                <br>
                <div class="col-sm-10">
                ...
                <form class="form-horizontal" action="index.php?include=konfirmasi-tambah-data-profil" method="post">
                    <div class="card-body">          
                        <div class="form-group row">
                            <label for="profil" class="col-sm-2 col-form-label">Nama Profil</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control" name="profil" id="profil" value="">
                            </div>
                        </div>
                        <div class="form-group row">
